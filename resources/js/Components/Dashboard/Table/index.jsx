...
export default function DashboardTable({ tableData, routePrefix, rowRender, suffixName }) {
    return (
        <div className="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <section>
                <div className="sm:flex sm:items-center sm:justify-between">
                    ...
                    <a href={route(`${routePrefix}.create`)} className="flex items-center mt-4 gap-x-3">
