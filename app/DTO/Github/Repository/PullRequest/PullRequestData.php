...
class PullRequestData extends Data
{
    public function __construct(
        ...
        public int $number,
        #[MapOutputName('status')] public State $state,
        public bool $locked,
        public string $title,
        public OwnerData $user,
        #[MapOutputName('description')] public ?string $body,
        ...
        #[WithTransformer(DateTimeInterfaceTransformer::class)] public ?CarbonImmutable $closedAt,
        #[WithTransformer(DateTimeInterfaceTransformer::class)] public ?CarbonImmutable $mergedAt,
        public ?int $comments,
